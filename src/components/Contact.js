...
const Contact = ({ openModal, handleClose }) => {
	...
	const errorMsg = showError ? (
		<li>There was an error sending your message. Please try again later.</li>
	) : (
		''
	);
	...
	return (
		<Modal
			...
			<Box
				sx={{
					backgroundColor: 'var(--white-see-through)',
				...
				<>
					<div className="contact-container">
						...
						<form className="contact-form" onSubmit={handleSubmit}>
							...
							<button className="submit-btn" type="submit" data-cy="submit">
