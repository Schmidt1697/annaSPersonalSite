  ...
  return (
    <div className='about container'>
      ...
      <img className="about-img" src={AboutPhoto} alt="Anna" />
        ...
        <p>
        I'm a software developer with experience building full stack applications with React.js and Ruby on Rails. I completed the software engineering bootcamp at Flatiron School in December 2022. I love that learning is a continuous and integral part of the programming. I thoroughly enjoy growing my programming skills and am currently learning to build with Node.js and Python. 
        </p>
        <p>
        ...
        <p>
        Aside from coding, I LOVE being outside! I'm fortunate to call Colorado my home. High alpine lakes, technical ridgelines, and running many miles on trails overgrown with wildflowers are a few of my favorite things.
        </p>
      </div>
